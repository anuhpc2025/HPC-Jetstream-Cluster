...
unset UCX_TLS UCX_IB_GPU_DIRECT_RDMA UCX_MEMTYPE_CACHE UCX_RNDV_SCHEME UCX_IB_PCI_RELAXED_ORDERING
...
# Run the MPI program
srun --mpi=pmix_v4 --cpu-bind=cores --ntasks-per-node=64 \
